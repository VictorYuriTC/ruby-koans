...
class AboutTrueAndFalse < Neo::Koan
  ...
  def test_everything_else_is_treated_as_true
    assert_equal truth_value(true), truth_value(1)
    assert_equal truth_value(true), truth_value(0)
    assert_equal truth_value(true), truth_value([])
    assert_equal truth_value(true), truth_value({})
    assert_equal truth_value(true), truth_value("Strings")
    assert_equal truth_value(true), truth_value("")
  end
